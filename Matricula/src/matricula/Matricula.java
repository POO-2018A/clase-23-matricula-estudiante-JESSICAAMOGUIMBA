...
public class Matricula extends javax.swing.JFrame {  
    ArrayList<Estudiante> itemsEstudiantes = new ArrayList<Estudiante>();
    Estudiante objEstudianteSeleccionado = new Estudiante();//necesita un constructor vacio en la clase Estudiante
    
    
    ArrayList<Materia> Materias = new ArrayList<Materia>();
    Materia objMateriaSeleccionada = new Materia();//necesita un constructor vacio en la clase Materia
   
 
    List<Materia> listaMatricula = new ArrayList<Materia>();
    DefaultComboBoxModel listaMatriculasModel = 
            new DefaultComboBoxModel(listaMatricula.toArray());
    //Tablas
    String [][] materias;
    ...
    private void initComponents() {
        ...
        txtMatriculas = new javax.swing.JTextArea();
        ...
        txtMatriculas.setColumns(20);
        txtMatriculas.setRows(5);
        jScrollPane4.setViewportView(txtMatriculas);
    ...
    private void btnAgregarMateriaActionPerformed(java.awt.event.ActionEvent evt) {                                                  
       ...
       if (!nombreMateria.equals("")) {
           ...
           listaMateriasModel.addElement(newMateria);   //agrega la materia en la lista del combo
    ...
    private void btnRegistrarEstudianteActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        
        Estudiante newEstudiante = new Estudiante(txtNombreEstudiante.getText(), txtApellidoEstudiante.getText(),txtEdadEstudiante.getText());
        String nombreEst = txtNombreEstudiante.getText();
        String apellidoEst = txtApellidoEstudiante.getText();
        String edad = txtEdadEstudiante.getText();
        
        if (!nombreEst.equals("")&&!apellidoEst.equals("")&&!edad.equals("")) {
            ...
            if (confirmacionEstudiante ==0) {
                ...
                listaEstudiantesModel.addElement(newEstudiante); //agrega al estudiante en la lista del combo
    ...
    private void btnMatricularEstudianteActionPerformed(java.awt.event.ActionEvent evt) {                                                        
        // TODO add your handling code here:

    String Texto =("");

    objEstudianteSeleccionado = (Estudiante)cmbListaEstudiantes.getSelectedItem();
    objMateriaSeleccionada = (Materia)cmbListaMaterias.getSelectedItem();
   
    Texto = Texto + "estudiante:   "+objEstudianteSeleccionado.imprimir()+"     "+"Materia:   "+ objMateriaSeleccionada.imprimir();
    txtMatriculas.setText(Texto);
     


    }                                                       

    private void cmbListaMateriasActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        // TODO add your handling code here:  
    }                                                

    private void cmbListaEstudiantesActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        // TODO add your handling code here:
    }                                                   
    ...
    private javax.swing.JTextArea txtMatriculas;
